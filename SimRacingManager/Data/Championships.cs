...
{
    private static Championship Y2025Q1 = new("Quarter 1", 2025, new DateTime(2025, 2, 5), new DateTime(2025, 4, 3), Status.Completed, 
    ...
    private static Championship Y2025Q2 = new("Quarter 2", 2025, new DateTime(2025, 4, 16), new DateTime(2025, 6, 25), Status.Ongoing, 
        [Drivers.Adam, Drivers.Damien, Drivers.Harvey, Drivers.Lee, Drivers.Matthew, Drivers.Trent], 
